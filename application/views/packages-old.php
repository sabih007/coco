...
<?php }?>
                                        <div class="ribbon"><span>
                                                ...
                                                <?php print_r($packagesbyname[2]['discount']);  ?>% OFF
                                       ...
                                       <!--  <div class="client-text ib-cls-rw SilverFritoSat btop">
                                            <p class="round-uz-class-clss" style="font-size: 16px !important;">
                                                <?php echo $shortname; ?> Package </p>
                                            <div class="ribbon"><span><?php print_r($packagesbyname[2]['discount']);  ?>% OFF</span></div>
                                        </div> -->
                                        <div class="client-face wow fadeInRight" data-wow-delay=".9s">
                                ...
                                <div class="card-body">
                                    <!-- Nav tabs -->
                                    <ul class="nav nav-tabs Package_tab" style="display: flex;" role="tablist">
                                        <li class="active"><a href="#previousIssue2" role="tab" data-toggle="tab">Day</a></li>
                                        <li><a href="#currentIssue2" role="tab" data-toggle="tab">Night</a></li>
                                        <li><a href="#nextIssue2" role="tab" data-toggle="tab">Day/Night</a></li>
                                    </ul>

                                    <!-- Tab panes -->
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="previousIssue2">
                                            <?php print_r($packagesbyname[2]['discount']); ?>%
                                            </p>
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item">
                                                    Rs <?php print_r($packfifty[0]['Rates']); ?>
                                                <li class="list-group-item">
                                                    <?php print_r($packfifty[0]['TimeSlot']); ?>
                                                </li>
                                                <li class="list-group-item">
                                                    <?php print_r($packfifty[0]['WeekDays']); ?>
                                                </li>
                                                <li class="list-group-item">
                                                    <div class="card-footers  bbtm">
                                                        <button class="btn btn-danger cls-uz-btn" data-toggle="modal" data-target="#bookbypckg" data-slotname="<?php print_r($packfifty[0]['TimeSlot']); ?>">Book Now</button>
                                                    </div>
                                                </li>

                                            </ul>
                                        </div>
                                        <div class="tab-pane" id="currentIssue2">
                                            <?php print_r($packagesbyname[2]['discount']); ?>%
                                            </p>
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item">
                                                    Rs <?php print_r($packfifty[1]['Rates']); ?>
                                                <li class="list-group-item">
                                                    <?php print_r($packfifty[1]['TimeSlot']); ?>
                                                </li>
                                                <li class="list-group-item">
                                                    <?php print_r($packfifty[1]['WeekDays']); ?>
                                                </li>
                                                <li class="list-group-item">
                                                    <div class="card-footers  bbtm">
                                                        <button class="btn btn-danger cls-uz-btn" data-toggle="modal" data-target="#bookbypckg" data-slotname="<?php print_r($packfifty[1]['TimeSlot']); ?>">Book Now</button>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="tab-pane" id="nextIssue2">
                                            <?php print_r($packagesbyname[2]['discount']); ?>%
                                            </p>
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item">
                                                    Rs <?php print_r($packfifty[2]['Rates']); ?>
                                                <li class="list-group-item">
                                                    <?php print_r($packfifty[2]['TimeSlot']); ?>
                                                </li>
                                                <li class="list-group-item">
                                                    <?php print_r($packfifty[2]['WeekDays']); ?>
                                                </li>
                                                <li class="list-group-item">
                                                    <div class="card-footers   bbtm">
                                                        <button class="btn btn-danger cls-uz-btn" data-toggle="modal" data-target="#bookbypckg" 
                                                        data-slotname="<?php print_r($packfifty[2]['TimeSlot']); ?>">Book Now</button>
                                                    </div>
                                                </li>
