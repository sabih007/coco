                            ...
                            <fieldset>
                                <div class="container">
                                    ...
                                    <div class="row">
                                       ...
                                       <!--  <div class="form-group    col-md-3">
                                            <label for="ExcessPerson">Excess Persons</label>
                                            <input type="number" class="form-control" placeholder="Excess Persons Allowed" name="ExcessPerson" required>
                                        </div> -->
                            ...
                            if (!empty($farmhouse)) {
                                foreach ($farmhouse as $record) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a  href="Farmhouse_edit/<?php echo $record['HouseID'] ?>">
                                                <i class="btn btn-sm round btn-outline-success fa fa-edit"></i>
                                            </a>
