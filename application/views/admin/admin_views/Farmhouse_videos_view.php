    ...
    <div class="nest">
        <div class="title-alt">
            ...
            <div class="titleClose">
                <button type="button" class="  btn btn-success">
                    <a href="<?php echo base_url(); ?>Add_Farmhouse_videos">Add Farmhouse Videos</a></button>
            </div>
        </div>
        ...
        <div class="body-nest">
            <table id="example" class="table table-striped table-bordered">
                ...
                <tbody>
                    <?php
                    if (!empty($farmhouse_videos)) {
                        foreach ($farmhouse_videos as $record) {
                            ?>
                    <tr>
                       ...
                       <!--      <a class="btn btn-sm btn-info" data-toggle="modal" data-target="#serviceModal"
                            ...
                            <a class="btn btn-sm btn-danger deleteUser" href="<?php echo base_url() . 'user/videos_delete/' . $record['id'];  ?>"
