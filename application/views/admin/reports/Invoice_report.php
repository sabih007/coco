...
<br>
<!-- <p style="float: right"> Weekdays</p>

  <span  class="dot ml-auto" > </span>

  <p style="float: right"> Friday to Saturday</p>
  <span  class="dot ml-auto" style="background-color: #ba9bac"> </span>
  Saturday to Sunday
  <span  class="dot ml-auto"  style="background-color:#8addff "> </span>
