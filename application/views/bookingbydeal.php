                                ...
                                <table class="table table-responsive table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            foreach ($farmhouse_menu as $value) {
                                                if ($formdata['HouseName'] == $value['Name']) {
                                                    ...
                                                    <td class="text-right price farm_center" width="15%"><?php echo $formdata['deal_val']; ?></td>
                                                    <input type="hidden" name="Deal_ID" value="<?php echo $formdata['Deal_ID']; ?>">
                                                    <input type="hidden" name="DealTitle" value="<?php echo $formdata['Deal_Title']; ?>">
                                            <?php
                                                }
                                            }
                                            ?>
                                        ...
                                        <tr>
                                                ...
                                                <td class="text-right" width="15%"> <?php echo $formdata['deal_val']; ?></td>
                                                <input type="text" name="BookedAmount" hidden="" value="<?php echo $formdata['deal_val']; ?> ">
  ...
  <label for="louie">Housework</label>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 terms">
                                        ...
                                        <tr>
                                            ...
                                            foreach ($farmhouse_menu as $value) {
                                                if ($formdata['HouseName'] == $value['Name']) {
                                                    ...
                                                    <td class="text-right price" width="15%"><?php echo $formdata['deal_val']; ?></td>
                                            <?php
                                                }
                                            }
                                            ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php } else { ?>
                                                <th colspan="2" class="text-right">Total (incl. tax)</th>
                                                <td class="text-right" width="15%"> <?php echo $formdata['deal_val']; ?>
                                                    <input type="text" name="BookedAmount" hidden="" value="<?php echo $formdata['deal_val']; ?> ">
                                                <?php  } ?>
                        ...
                        <div class="wizard-footer">
                            <div class="pull-right">
                                <input type='button' id="button" class='btn btn-next btn-booking btn-primary btn_last' onclick="myFunc2()" name='next' value='Next' />
...
<script type="text/javascript">
    function myFunc2() {
        ...
        // alert(document.getElementById("sum1").textContent);
