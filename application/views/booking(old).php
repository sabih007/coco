                    ...
                    <form id="forms" method="post" action="<?php echo base_url('booking_web'); ?>">
                            ...
                            <div class="tab-pane" id="step3">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Special Request: <small>(optional with "," separator eg:
                                                Travel,Housework)</small></label>
                                            ...
                                            <section id="id-100" class="post single ">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 urdus" style="float:left; width:50%;">
                                                        <h3 class="available_at"> What to Bring: </h3>
                                                        <div class="row">
                                                            <div class="col-md-11 col-sm-11 farm_urdu">اور بازار سے لے آئے اگر
                                                                ٹوٹ گیا
                                                                ساغرِ جم سے مرا جامِ سفال اچّھا ہے</div>
                                                            <div class="col-md-1 col-sm-1">.1</div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-11 col-sm-11 farm_urdu">اور بازار سے لے آئے اگر
                                            ...
                                            ?>
                                                ...
                                                <section id="id-100" class="post single ">
                                                    ...
                                                    <div class="row">
                                                      ...
                                                      <div class="col-md-6 col-sm-6 urdus" style="float:left; width:50%;">
                                                        <h3 class="available_at">اہم ہدایات</h3>
                                                        <div class="row">
                                                            <div class="col-md-11 col-sm-11 farm_urdu">دوران پارثی مالی کو پانی ڈالنے کی اجازت ھوگی۔ </div>
                                                            <div class="col-md-1 col-sm-1">.1</div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-11 col-sm-11 farm_urdu">پارٹی کے دوران ڈرون کیمرا استعمال نہیں ہوگا</div>
                                                            <div class="col-md-1 col-sm-1">.2</div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-11 col-sm-11 farm_urdu">کسی بھی قسم کی فلیش لائٹ لیزر لائٹ سرچ لائٹ استعمال نہیں ھوگی</div>
                                                            <div class="col-md-1 col-sm-1">.3</div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-11 col-sm-11 farm_urdu">ڈانس پارٹی نہیں ہوگی<div>
                                                            <div class="col-md-1 col-sm-1">.4</div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-11 col-sm-11 farm_urdu">کسی بھی کسم کی نشہ وار چیز کا استمال نہی ہوگا</div>
                                                            <div class="col-md-1 col-sm-1">.5</div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-11 col-sm-11 farm_urdu">.کسی بھی قسم کی ہتھیاروں کی نمائش اور آتشبازی ممنوع ہے</div>
                                                            <div class="col-md-1 col-sm-1">.6</div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-11 col-sm-11 farm_urdu">اونچی آواز میں موسیقی بجانا ممنوع ہے</div>
                                                            <div class="col-md-1 col-sm-1" style="float:left; width:5%;">.7</div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-11 col-sm-11 farm_urdu">پہلے ، فارم ہاؤس میں داخل ہوکر تمام سہولیات کی جانچ کریں۔ 15 منٹ کے اندر اندر ناقابل فہم ہونے کی صورت میں فارم ہاؤس چھوڑ دیں۔ اور اپنی ادا شدہ رقم کا 50٪ لے لو۔ اگر آپ 15 منٹ کے اندر فارم ہاؤس نہیں چھوڑتے ہیں تو ہم آپ کو ادائیگی واپس نہیں دیں گے</div>
                                                            <div class="col-md-1 col-sm-1" style="float:left; width:5%;">.8</div>
                                                        </div>
                                                          <div class="row">
                                                            <div class="col-md-11 col-sm-11 farm_urdu">میں تمام شرائط و ضوابط سے اتفاق کرتا/کرتی ہوں۔اور سائن کررھا/کرھی ھو۔</div>
                                                            <div class="col-md-1 col-sm-1" style="float:left; width:5%;">.9</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        <div class="col-sm-12">
                        ...
                        <div class="wizard-footer">
                            <div class="pull-right">
                                <input type='button' id="button" class='btn btn-next btn-booking btn-primary btn_last' onclick="myFunction()" name='next' value='Next' />
...
<script type="text/javascript">
    function myFunction() {
        document.getElementById("sum").innerHTML = " Name : " + document.getElementById("fullname").value +
        ...
        document.getElementById("sum1").innerHTML = document.getElementById("sum").value;
    }
</script>
