                            ...
                            <div id="list-type" class="proerty-th-list">
                                <div class="col-sm-6 col-md-3 p0">
                                    <div class="box-two proerty-item">
                                        ...
                                        <div class="item-entry overflow">
                                            <form action="<?php echo base_url('booking_by_deal'); ?>" class=" form-inline" method="post">
                                ...
                                <option value="21-Hours (8PM to 5PM)">21-Hours (8PM to 5PM)</option> -->
                                                ...
                                                <div class="form-group" style="display: none !important;">
                                                    ...
                                                    <input type="hidden" name="deal_val" value="<?php echo $postdata['deal_value'];?>">
                                                    <input type="hidden" name="Deal_ID" value="<?php echo $postdata['Deal_ID'];?>">
                                                    <input type="hidden" name="Deal_Title" value="<?php echo $postdata['Deal_Title'];?>">
                                                </div>
...
<a href="<?php echo base_url() . 'farmhouse/' . $value['HouseID'];  ?>"><?php echo $value['Name']; ?></a>&nbsp;
 ...
 <span style="color: #860a08;">Actual Rates: Rs</span> <span style="text-decoration: line-through; color: #860a08" ><?php echo $value['Rent']; ?></span>/-</span>
    </h5>
     <div class="dot-hr"></div>
    <span class="pull-left"><b>Capacity : </b>
     <?php echo $value['Capacity']; ?> <i class="pe-7s-users"></i></span>
    <h3><span class="proerty-price pull-right" style="font-weight: 500; font-size: 14px;
    line-height: 1; color: green;"><strong> <i class="fa fa-check-circle"> </i> Rs:
    <?php echo $postdata['deal_value'];?> </strong></span></h3><br>
